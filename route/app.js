...
router.post("/newAdmin", function(req, res, next) {
  ...
  pool.getConnection(function(err, connection) {
    if (req.body.Key == "Edit") {
      console.log("EDIT");
      var sql = 'UPDATE admin SET Name = "' + req.body.Name + '",Email ="' + req.body.Email + '", Address ="' + req.body.Address + '",City = "' + req.body.City + '", Pincode = "' + req.body.Pincode + '" WHERE (Mobile)="' + req.body.Mobile + '"; UPDATE login SET Name = "' + req.body.Name + '",Email = "' + req.body.Email + '" WHERE (User)="' + req.body.Mobile + '"';
...
router.post("/newIti", function(req, res, next) {
  ...
  pool.getConnection(function(err, connection) {
    if (req.body.Key == "Edit") {
      console.log("EDIT");
      var sql = 'UPDATE college SET Name = "' + req.body.Name + '",Registration = "' + req.body.Registration + '",Landline = "' + req.body.Landline + '",Email = "' + req.body.Email + '", Mobile = "' + req.body.Mobile + '",Type = "' + req.body.Type + '", Address ="' + req.body.Address + '",City = "' + req.body.City + '",State = "' + req.body.State + '",District ="' + req.body.District + '", Pincode = "' + req.body.Pincode + '", TPO_Name = "' + req.body.TPO_Name + '", TPO_Email = "' + req.body.TPO_Email + '", Logo = "' + req.body.Logo + '" WHERE (TPO_Mobile)="' + req.body.TPO_Mobile + '"; UPDATE login SET Name = "' + req.body.Name + '", Email = "' + req.body.TPO_Email + '" WHERE (User)="' + req.body.TPO_Mobile + '"';
      connection.query(sql, function(err, result) {
        if (err) {
          return console.log(err);
        } else {
            ...
            connection.query('SELECT * FROM college WHERE Name = "' + req.body.Name + '" AND ( City = "' + req.body.City + '" OR Pincode = "' + req.body.Pincode + '")', function(err, result1) {
              if (err) {
                ...
                if (result1 != '') {
                  ...
                  connection.query('INSERT INTO college(Name,Registration,Landline,Email,Mobile,Type,Address,City,State,Pincode,District,TPO_Name,TPO_Email,TPO_Mobile,Logo,Date) VALUES ("' + req.body.Name + '","' + req.body.Registration + '","' + req.body.Landline + '","' + req.body.Email + '","' + req.body.Mobile + '","' + req.body.Type + '","' + req.body.Address + '","' + req.body.City + '","' + req.body.State + '","' + req.body.Pincode + '","' + req.body.District + '","' + req.body.TPO_Name + '","' + req.body.TPO_Email + '","' + req.body.TPO_Mobile + '","' + req.body.Logo + '","' + date + '","' + req.body.TPO_Email + '")', function(err, result2) {
                    if (err) {
                      return next(err);
                    } else {
                      console.log("result2");
